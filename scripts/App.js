      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.categories}>
          {Object.keys(categoryIcons).map((category) => (
            <TouchableOpacity style={styles.category} key={category}>
              <MaterialIcons name={categoryIcons[category]} size={32} color="#6A64F1" />
        ...
        {[
          { name: 'Olivia Wilson', specialty: 'Physiotherapy', image: 'https://randomuser.me/api/portraits/women/44.jpg' },
          { name: 'Jonathan Patterson', specialty: 'Internal Medicine', image: 'https://randomuser.me/api/portraits/men/45.jpg' },
        ].map((doctor, index) => (
